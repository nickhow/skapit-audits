    ...
    <div class="row bg-white rounded p-3">
        ...
        <div class="col-12">
            <?php if($audit_obj['is_payable']): ?> 
                <div class="alert alert-warning"><?php echo($text['audit_payment_intro']); ?></div>
            <?php endif  ?>
        </div>
    </div>
    <?php endif; ?>
                    ...
                    success: function(data) {
                        ...
                        questions.forEach(function(question){
                        	...
                        	//nothing
                                ...
                                el.innerHTML= '<b><i>Feedback: </i></b>';
                                if( responses[qid]['comment'] == ''){
                                    el.innerHTML += '<i>none</i>';
                                } else {
                                    el.innerHTML += responses[qid]['comment'];
                                }
