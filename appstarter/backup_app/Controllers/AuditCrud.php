...
class AuditCrud extends Controller
{
    ...
    public function chaseEmail($audit_id = null){
        ...
        $url =  "https://audit.ski-api-technologies.com/audit/".$audit_id;
    ...
    public function hotelCheckStore() {
        ...
        if($this->request->getVar('complete')){
            ...
            //$emailaddresses=('fraser@skapit.com'); //LIVE
            //$emailaddresses=('fraser@skapit.com, nick@skapit.com');  // TEST
            $emailaddresses=('fraser@skapit.com');
    ...
    public function save(){
        ...
        if($this->request->getVar('complete')) { //complete button
            ...
            if($audit['is_payable']){
               ...
               //TEST :: $emailaddresses=('nick@skapit.com');  
