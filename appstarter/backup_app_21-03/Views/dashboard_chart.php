...
<script>
    ...
    function refresh(days){
      // $('#charts').html('<object data="https://audit.ski-api-technologies.com/refresh-stats/2">');   //kinda works
    ...
    for (var button of buttons) {
      ...
      $('#chases').load("https://audit.ski-api-technologies.com/refresh-stats/"+days); 
