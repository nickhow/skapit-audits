...
class AuditModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'total_score_ba','total_score_abta','total_score_dnata',
        'status','result_ba','result_abta','result_dnata',
        'sent_date','last_updated','completed_date',
        'audited_date','expiry_date_ba','expiry_date_abta', 'expiry_date_dnata',
