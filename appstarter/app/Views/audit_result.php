                ...
                <div class="col text-center">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-12">
                         ...
                         <p>This result expires on <?php echo  date('d/m/Y', strtotime($audit_obj['expiry_date_ba']));?> for BA, <?php echo  date('d/m/Y', strtotime($audit_obj['expiry_date_abta']));?> for ABTA, and <?php echo  date('d/m/Y', strtotime($audit_obj['expiry_date_dnata']));?> for dnata.</p>
                    </div>
