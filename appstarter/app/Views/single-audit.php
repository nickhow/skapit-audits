            ...
            <?php if($audit_obj['status'] == "reviewed") : ?>
                  <div class="col-12 col-lg-5 h-100 sticky-lg-top p-0">
                    ...
                    <div class="bg-white rounded p-4 mx-lg-3 my-3 mt-lg-0 mb-4">
                              ...
                              <div class="col-12 my-3">
                                  ...
                                  <table class="table">
                                    <thead>
                                      ...
                                      <tr>
                                        <td>EJH</td>
                                        <td><?php echo ucFirst($audit_obj['result_ejh'])?></td>
                                        <td><?php echo date('d/m/Y', strtotime($audit_obj['expiry_date_ejh']));?></td>
                                      </tr>
                                      <tr>
                                    </tbody>
                                    </table>
                              ...
                              <?php if( $audit_obj['result_ba'] == "unsuitable" || $audit_obj['result_abta'] == "unsuitable" || $audit_obj['result_ejh'] == "unsuitable") : ?>
                                <div class="py-2">
