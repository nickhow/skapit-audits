  ...
  <div class="container-md mt-5 pb-5 mb-3">
    ...
    <?php if($audit_obj['status'] == 'reviewed'): ?>
        <div class="row p-3">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <div class="col-12">
                        ...
                        <h2><?php echo "dnata: ". ucFirst($audit_obj['result_dnata']);?></h2>
                    </div>
                </div>
            ...
            <p>
                This result expires on <?php echo  date('d/m/Y', strtotime($audit_obj['expiry_date_ba']));?> for BA,
                <?php echo  date('d/m/Y', strtotime($audit_obj['expiry_date_abta']));?> for ABTA
                and <?php echo  date('d/m/Y', strtotime($audit_obj['expiry_date_dnata']));?> for dnata.
            </p>
    ...
    <form method="post" id="update_audit" name="update_audit" enctype="multipart/form-data" action="<?= site_url('/save-responses') ?>">
     ...
     <?php } ?>
        ...
        <!-- NEW -->
        <?php  /* Question 134 */ $question = $questions[133]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
        ...
        <?php  /* Question 133 */ $question = $questions[132]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
        ...
        <!-- NEW -->
        <?php  /* Question 135 */ $question = $questions[134]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
        ...
        <?php } ?>
        <!-- NEW -->
        <?php  /* Question 138 */ $question = $questions[137]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
        ...
        <!-- NEW -->
        <?php  /* Question 136 */ $question = $questions[135]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
...
<!-- 78 + 79 used to be here -->
        ...
        <!-- NEW -->
        <?php  /* Question 137 */ $question = $questions[136]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
     ...
     <?php } ?>
        ...
        <!-- new questions - 21 Nov -->
        <?php  /* Question 131 */ $question = $questions[130]; ?> 
        <?php if($question['hide_for_1'] && $audit_obj['type'] == 1
        || $question['hide_for_2'] && $audit_obj['type'] == 2
        || $question['hide_for_3'] && $audit_obj['type'] == 3
        || $question['hide_for_4'] && $audit_obj['type'] == 4
                    ...
                    success: function(data) {
                        ...
                        questions.forEach(function(question){
                        	...
                        	//nothing
                                ...
                                if( responses[qid]['score_ba'] >= 100015 || responses[qid]['score_abta'] >= 100015 || responses[qid]['score_dnata'] >= 100015 ){
                    ...
                    success: function(data) {
                        ...
                        questions.forEach(function(question){
                        	...
                        	//nothing
                                ...
                                el.innerHTML += ' dnata: '+responses[qid]['score_dnata'];
                                el.innerHTML += '</div>'
                                parent.appendChild(el);
